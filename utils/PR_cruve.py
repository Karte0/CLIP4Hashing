...
def calc_value(hash_mat, data_name):
    ...
    for mat in hash_mat:
        ...
        i2t = precision_recall(query_img, retrieval_txt, query_label, retrieval_label)
        t2i = precision_recall(query_txt, retrieval_img, query_label, retrieval_label)
        i2ts.append(i2t)
        t2is.append(t2i)
    return i2ts, t2is
...
def draw_PR(path, data_name):
    ...
    PR_curve(i2ts, ['i2t'], "pr_curve")
    PR_curve(t2is, ['t2i'], "pr_curve")
